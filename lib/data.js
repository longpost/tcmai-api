// lib/data.js
// v1.3 — add TAG_LABELS (bilingual tag display names)
...
// core:+2 assist:+1
// NOTE: Tags are kept as Chinese keys (stable keys), use TAG_LABELS to display bilingual names.
// ---------------------------
...
// ---------------------------
// ✅ Tag display labels (bilingual) — NEW
// Use this to display tag names in EN/ZH while keeping Chinese tag keys stable.
// ---------------------------
export const TAG_LABELS = {
  "心气不足": { zh: "心气不足", en: "Heart Qi deficiency" },
  "心神不宁": { zh: "心神不宁", en: "Disturbed shen (restless spirit)" },
  "心阴不足": { zh: "心阴不足", en: "Heart Yin deficiency" },
  "心火偏旺": { zh: "心火偏旺", en: "Exuberant Heart Fire" },

  "肺气不足": { zh: "肺气不足", en: "Lung Qi deficiency" },
  "肺阴不足": { zh: "肺阴不足", en: "Lung Yin deficiency" },
  "痰浊中阻": { zh: "痰浊中阻", en: "Phlegm-damp obstruction" },
  "痰热壅肺": { zh: "痰热壅肺", en: "Phlegm-heat congesting the lungs" },
  "寒痰内盛": { zh: "寒痰内盛", en: "Cold-phlegm accumulation" },

  "肝阳偏亢": { zh: "肝阳偏亢", en: "Liver Yang rising" },
  "肝火偏旺": { zh: "肝火偏旺", en: "Liver Fire blazing" },
  "肝气郁结": { zh: "肝气郁结", en: "Liver Qi constraint" },
  "肝血不足": { zh: "肝血不足", en: "Liver Blood deficiency" },
  "肝脾不和": { zh: "肝脾不和", en: "Liver–Spleen disharmony" },

  "肾精不足": { zh: "肾精不足", en: "Kidney Essence deficiency" },
  "肾阳不足": { zh: "肾阳不足", en: "Kidney Yang deficiency" },
  "肾阴不足": { zh: "肾阴不足", en: "Kidney Yin deficiency" },

  "阳虚体质": { zh: "阳虚体质", en: "Yang-deficient constitution" },
  "阴虚火旺": { zh: "阴虚火旺", en: "Yin deficiency with deficiency-heat" },

  "气血不足": { zh: "气血不足", en: "Qi & Blood deficiency" },
  "卫气不固": { zh: "卫气不固", en: "Defensive Qi instability" },
  "气虚下陷": { zh: "气虚下陷", en: "Qi deficiency with sinking" },

  "脾气虚弱": { zh: "脾气虚弱", en: "Spleen Qi deficiency" },
  "脾胃虚弱": { zh: "脾胃虚弱", en: "Spleen–Stomach weakness" },
  "脾阳虚": { zh: "脾阳虚", en: "Spleen Yang deficiency" },
  "寒湿困脾": { zh: "寒湿困脾", en: "Cold-damp obstructing the middle" },
  "湿阻中焦": { zh: "湿阻中焦", en: "Dampness obstructing the middle" },

  "湿热下注": { zh: "湿热下注", en: "Damp-heat pouring downward" },

  "里热偏盛": { zh: "里热偏盛", en: "Excess internal heat" },
  "热结肠腑": { zh: "热结肠腑", en: "Heat binding in the intestines" },
  "里实": { zh: "里实", en: "Interior excess (constraint tag)" },
  "津液不足": { zh: "津液不足", en: "Insufficient body fluids" },

  "食滞胃肠": { zh: "食滞胃肠", en: "Food stagnation" },
  "胃气不和": { zh: "胃气不和", en: "Disharmony of Stomach Qi" },
  "胃气上逆": { zh: "胃气上逆", en: "Rebellious Stomach Qi" },
  "胃火偏旺": { zh: "胃火偏旺", en: "Exuberant Stomach Fire" },
  "肝胃不和": { zh: "肝胃不和", en: "Liver–Stomach disharmony" },

  "气滞": { zh: "气滞", en: "Qi stagnation" },
  "血瘀内阻": { zh: "血瘀内阻", en: "Blood stasis" },
  "水湿内停": { zh: "水湿内停", en: "Dampness / fluid retention" },

  "风寒外袭": { zh: "风寒外袭", en: "Wind-cold invasion" },
  "风热犯肺": { zh: "风热犯肺", en: "Wind-heat affecting the lungs" },

  "寒凝胞宫": { zh: "寒凝胞宫", en: "Cold congealing in the uterus (illustrative)" },
};
