// lib/data.js
// 这是一个“最小闭环可跑”的数据版本：症状(id/zh/en) + 证素标签规则 + 组合规则 + 解释/治法模板
// 你后续扩展：只要追加 SYMPTOMS 与 SYMPTOM_TAG_RULES/COMBO_RULES 即可。

export const SYMPTOMS = [
  { id: "palpitations", zh: "心悸", en: "Palpitations" },
  { id: "yellow_sticky_phlegm", zh: "痰黄黏", en: "Yellow sticky phlegm" },

  { id: "loose_stool", zh: "便溏", en: "Loose stool" },
  { id: "constipation", zh: "大便干结", en: "Dry constipation" },

  { id: "clear_long_urine", zh: "小便清长", en: "Clear copious urine" },
  { id: "short_red_urine", zh: "小便短赤", en: "Dark scanty urine" },

  { id: "cold_aversion", zh: "畏寒肢冷", en: "Aversion to cold / cold limbs" },
  { id: "cold_limbs", zh: "手脚冰凉", en: "Cold limbs" },

  { id: "five_center_heat", zh: "五心烦热", en: "Five-center heat" },
  { id: "palm_sole_heat", zh: "手足心热", en: "Heat in palms/soles" },

  { id: "fatigue", zh: "乏力", en: "Fatigue" },
  { id: "lazy_low_energy", zh: "神疲懒言", en: "Lassitude / low speech" },
  { id: "pale_complexion", zh: "面色少华", en: "Pale complexion" },
  { id: "flushed_face", zh: "面色潮红", en: "Flushed complexion" },
  { id: "restlessness", zh: "烦躁", en: "Restlessness" },
];
